...
if (!$property) {
    echo "Sorry! We do not have any properties.";
    return;
}
$city_id = $property['city_id'];

$sql_2 = "SELECT * FROM interested_users_properties WHERE property_id = $property_id";
...
$sql_4 = "SELECT * FROM amenities a INNER JOIN properties_amenities pa ON a.id = pa.amenity_id WHERE pa.property_id = $property_id ";
...
$sql_5 = "SELECT * FROM testimonials WHERE property_id = $property_id";
    ...
    <div class="property-summary page-container">
        <div class="row no-gutters justify-content-between">
            ...
            <div class="interested-container">
                ...
                if ($is_interested) {
                ?>
                    <i class="is_interested_image fas fa-heart"></i>
                <?php
                } else {
                ?>
                    <i class="is_interested_image far fa-heart"></i>
                <?php
                }
                ?>
                ...
                <div class="interested-text ">
                    <span class="interested_user_count">
